...
{
    set_servo_proportional_("LF_KNEE", msg->angular.z);
    set_servo_proportional_("LF_SHOULDER", msg->angular.z);
    set_servo_proportional_("LF_HIP", msg->angular.z);
    set_servo_proportional_("RF_KNEE", msg->angular.z);
    set_servo_proportional_("RF_SHOULDER", msg->angular.z);
    set_servo_proportional_("RF_HIP", msg->angular.z);
    set_servo_proportional_("LB_KNEE", msg->angular.z);
    set_servo_proportional_("LB_SHOULDER", msg->angular.z);
    set_servo_proportional_("LB_HIP", msg->angular.z);
    set_servo_proportional_("RB_KNEE", msg->angular.z);
    set_servo_proportional_("RB_SHOULDER", msg->angular.z);
    set_servo_proportional_("RB_HIP", msg->angular.z);
}
