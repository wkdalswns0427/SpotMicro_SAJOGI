...
# dictionary of custom key inputs
key_value_default = {'w': 0, 'a': 0, 's': 0, 'd': 0, 'q': 0, 'e': 0, 'move': False }
joystick_value_default = {'A': 0, 'B': 0, 'C': 0, 'D': 0, 'E': 0, 'F': 0, 'K': 0, 'move': False }
...
# hopefully... https://www.ic114.com/WebSite/site/sc/00V0.aspx?id_p=P0084289
# also i2c, bluetooth or nRF24L01
class Joystick:
    def __init__(self):
        self.key_status = Queue()
        self.key_status.put(joystick_value_default)
